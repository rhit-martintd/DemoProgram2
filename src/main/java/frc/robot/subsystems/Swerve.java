...
public class Swerve extends SubsystemBase {
    ...
    public double distanceMod1(){
        SwerveModule mod1 = swerveMods[0];
        return mod1.getPosition().distanceMeters;
    }
    public double distanceMod2(){
        SwerveModule mod2 = swerveMods[1];
        return mod2.getPosition().distanceMeters;
    }

    public double distanceMod3(){
        SwerveModule mod3 = swerveMods[2];
        return mod3.getPosition().distanceMeters;
    }

    public double distanceMod4(){
        SwerveModule mod3 = swerveMods[3];
        return mod3.getPosition().distanceMeters;
    }
